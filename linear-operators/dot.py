...
ax3.quiver(*origin, *A_unit, angles='xy', scale_units='xy', scale=1, color='pink', width=0.006, label='Â (unit A)')
ax3.quiver(*origin, *B_unit, angles='xy', scale_units='xy', scale=1, color='cyan', width=0.006, label='B̂ (unit B)')
# Draw circles showing magnitudes
circle_A = Circle((0, 0), norm_A, color='r', fill=False, linestyle=':', alpha=0.3)
circle_B = Circle((0, 0), norm_B, color='b', fill=False, linestyle=':', alpha=0.3)
